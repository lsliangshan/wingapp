...
class Teachers extends Table {
  ...
  /// 2. part-time 兼职老师
  TextColumn get type =>
      text().nullable().withDefault(const Constant('全职老师'))();
  // 登录名
  ...
  // 性别，男、女
  TextColumn get gender => text().nullable().withDefault(const Constant('男'))();
  // 状态，在职、离职
  TextColumn get status =>
      text().nullable().withDefault(const Constant('在职'))();
  // 是否是管理员，0 否，1 是
